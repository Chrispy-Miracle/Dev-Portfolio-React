...
const About = () => {
    return (
        <>
            ...
            <div id="welcome">
                <img class="welcome-pics" src={gardenPic} alt="A pic of myself in front of flowering snow peas" />
                <p>Hi there!<br />My name is Christopher Patchett.<br /><br />I am a farmer and musician turned developer. </p> 
                <img class="welcome-pics" src={bassPic} alt="A pic of myself playing bass with Pherkad at Marble Brewery. credit: Keith Langerman" />
            </div>
            ...
            <img id="me-on-comp-pic" class="welcome-pics" src={computerPic} alt="A pic of myself with my laptop" />
